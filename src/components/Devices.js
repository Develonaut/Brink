...
export default function Devices() {
  return(
    <section className="devices modules">
      <ContentWrapper className="devices-wrapper" >
        <Heading>Notifications where you <strong>need</strong> them <strong>most</strong>.</Heading>
        ...
        <ul className="devices-list">
          ...
          <li className="device watch">
            <DeviceBadge>Even Smart Watches!</DeviceBadge>
          </li>
